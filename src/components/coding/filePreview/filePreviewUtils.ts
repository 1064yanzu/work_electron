...
export function getPreviewPathLabel(filePath: string | null, projectPath: string | null): string {
...
export function splitPreviewLines(content: string): Array<{ number: number; text: string }> {
