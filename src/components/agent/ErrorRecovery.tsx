...
function SuggestionButton({
	...
	const colorClasses: Record<RecoverySuggestion["action"], string> = {
		...
		skip: "bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-800 dark:hover:bg-zinc-700 text-zinc-700 dark:text-zinc-300",
...
function ErrorDetails({
	...
	return (
		<div className="space-y-3">
			...
			{/* 详细信息 */}
			{isExpanded && (
				<div className="p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg text-xs text-zinc-500 dark:text-zinc-400 space-y-2 animate-in fade-in slide-in-from-top-2">
...
export default function ErrorRecovery({
	...
	return (
		<div className="rounded-xl overflow-hidden bg-white dark:bg-zinc-900 ring-1 ring-red-200 dark:ring-red-800/50 shadow-lg animate-in fade-in slide-in-from-bottom-4 duration-300">
			{/* 警告条 */}
