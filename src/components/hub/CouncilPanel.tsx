					...
					{selectable.map((entry) => {
						...
						return (
							<button
								...
								className={cn(
									"px-2.5 py-1 rounded-lg text-xs font-medium transition duration-150 border",
									on
				...
				{progress && (
					<div className="space-y-1">
						...
						<div className="h-0.5 rounded-full bg-warm-200 overflow-hidden">
							<div
								className="h-full rounded-full bg-terracotta transition-[width] duration-250"
								style={{
									width:
										progress.phase === "reducing"
											? "92%"
				...
				{answers.length > 0 && (
					<section className="space-y-2">
						...
						{answers.map((answer) => (
							...
							>
								<summary className="flex items-center gap-1.5 px-3 py-2 cursor-pointer list-none hover:bg-warm-200/40 dark:hover:bg-cream-800/30 transition duration-150">
