...
const SandboxImagePreview = memo(function SandboxImagePreview({
	filePath,
	fileName,
	fileSize,
}: {
		...
		return (
			<div className="flex-1 flex flex-col items-center justify-center p-8 bg-white dark:bg-zinc-900">
				<div className="text-center space-y-2">
					...
					<p className="text-sm text-zinc-400">点击左侧文件查看内容</p>
				</div>
			</div>
		);
	}
...
const ArtifactPreview = memo(function ArtifactPreview({
	...
	if (!file) {
		return (
			<div className="flex-1 flex flex-col items-center justify-center p-8 bg-zinc-900">
				<div className="text-center space-y-2">
					<h3 className="text-lg font-medium text-zinc-300">暂无预览</h3>
					<p className="text-sm text-zinc-500">选择一个产物开始预览</p>
				</div>
			</div>
		);
	}
	...
	return (
		<div className="flex-1 flex flex-col items-center justify-center p-8 bg-zinc-50 dark:bg-zinc-900">
			<div className="text-center space-y-2">
				<p className="text-sm text-zinc-500">此文件类型不支持实时预览</p>
				<p className="text-xs text-zinc-400">请切换到文件视角查看内容</p>
			</div>
		</div>
	);
});
