...
export function GraphInspectorPanel({
	...
	return (
		<div
			className={cn(
				"absolute right-3 top-[4.5rem] z-20 pointer-events-auto transition-[color,background-color,border-color,opacity,box-shadow,transform] duration-150",
				collapsed
				...
				<div className="px-4 py-3 border-b border-border/60 flex items-start justify-between gap-3">
					...
					<div className="flex items-center gap-1">
						<button
							...
							className="p-2 rounded-xl text-text-light hover:text-text-secondary dark:hover:text-cream-200 hover:bg-warm-200/80 transition-colors"
							...
							<>
								<div className="flex items-center gap-2 flex-wrap">
									...
									<button
										...
										className="inline-flex items-center gap-2 px-3 py-2 rounded-2xl bg-warm-200 text-text-secondary dark:text-cream-200 text-xs font-medium hover:bg-warm-300/70 dark:hover:bg-cream-700/60 transition-colors"
									>
										{copiedTag === "input" ? (
											...
											{artifactsForTool.map((artifact) =>
												artifact.url ? (
													<button
														...
														className="w-full text-left inline-flex items-center justify-between px-2.5 py-2 rounded-xl hover:bg-surface/70 text-xs text-text-secondary dark:text-cream-200"
													>
								...
								<div className="rounded-2xl bg-warm-50/60 ring-1 ring-black/5 dark:ring-white/10 overflow-hidden">
									...
									<pre className="px-3 py-2 text-xs text-text-secondary dark:text-cream-200 whitespace-pre-wrap break-words">
								...
								<div className="rounded-2xl bg-warm-50/60 ring-1 ring-black/5 dark:ring-white/10 overflow-hidden">
									...
									<pre className="px-3 py-2 text-xs text-text-secondary dark:text-cream-200 whitespace-pre-wrap break-words max-h-60 overflow-y-auto">
							...
							{siblingSubagents.map((tc, idx) => {
								...
								return (
									<button
										...
										className={cn(
											"shrink-0 inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs font-medium transition-colors",
											isActive
