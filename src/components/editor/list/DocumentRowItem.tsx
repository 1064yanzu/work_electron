...
export function DocumentRowItem({
	...
	return (
		<article
			className={cn(
				"doc-card rounded-2xl border px-3 py-2.5 sm:px-4 sm:py-3 bg-white/95 dark:bg-zinc-900/78",
				"border-zinc-200/75 dark:border-zinc-700/70",
				...
				<div className="min-w-0 flex items-center gap-2.5 sm:gap-3">
					{isManaging ? (
						<button
							...
							className="focus-ring min-h-11 min-w-11 inline-flex items-center justify-center rounded-xl text-zinc-600 dark:text-zinc-200 bg-white/90 dark:bg-zinc-800/90 hover:bg-zinc-100 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700"
					...
					>
						<div className="h-10 w-10 rounded-xl border border-zinc-200/80 dark:border-zinc-700/70 bg-zinc-100/75 dark:bg-zinc-800/72 inline-flex items-center justify-center text-zinc-600 dark:text-zinc-300 shrink-0">
							<FileText className="w-4.5 h-4.5" />
						</div>

						<div className="min-w-0">
							<h3 className="text-[15px] font-semibold leading-6 text-zinc-900 dark:text-zinc-100 truncate">
								{output.title || "无标题文档"}
							</h3>
