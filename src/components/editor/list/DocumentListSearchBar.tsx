	...
	return (
		<div className="space-y-1.5">
			<div className="relative group">
				<Search className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-text-muted transition-colors group-focus-within:text-text-secondary dark:group-focus-within:text-text-light" />
				<input
					type="text"
					value={query}
				...
				{hasQuery ? (
					<button
						...
						className="focus-ring absolute right-1.5 top-1/2 -translate-y-1/2 min-h-8 min-w-8 inline-flex items-center justify-center rounded-lg text-text-muted hover:text-text-primary dark:hover:text-zinc-200 hover:bg-warm-200 transition-all active:scale-95"
						aria-label="清空搜索"
						title="清空搜索 (Esc)"
					>
						<X className="w-4 h-4" />
