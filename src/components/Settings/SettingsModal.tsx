...
export function SettingsModal({
	...
	return (
		<div
			className={`modal-backdrop fixed inset-0 z-overlay flex items-center justify-center bg-text-primary/20 backdrop-blur-sm font-sans ${isClosing ? "animate-fade-out" : "animate-in fade-in duration-150"}`}
			onMouseDown={(event) => {
