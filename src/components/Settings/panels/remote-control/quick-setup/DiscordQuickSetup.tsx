			...
			<div className="rounded-2xl border border-border bg-warm-200/30 p-5">
				...
				>
					<input
						...
						className="w-full rounded-xl border border-border bg-surface px-3 py-2.5 font-mono text-sm outline-none transition-[color,background-color,border-color,box-shadow] duration-150 ease-out focus:border-primary/60 focus:ring-2 focus:ring-primary/20"
					/>
				</StepBlock>
			</div>
