...
swatches: ["#4A154B", "#FFFFFF", "#F8F8F8", "#350D36", "#611F69"]
summary: "Slack's identity is built around the idea that work should feel human and even a little fun. The canonical surface is light — white content "
source: open-design
license: Apache-2.0
---

<!-- Source: open-design/design-systems/slack/DESIGN.md | License: Apache-2.0 | Imported: 2026-05-14 -->
