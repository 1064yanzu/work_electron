...
swatches: ["#313338", "#1E1F22", "#5865F2", "#2B2D31", "#4752C4"]
summary: "Discord's product is engineered for evenings, raids, and group voice — so the entire surface is dark-first. The default canvas is the deep B"
source: open-design
license: Apache-2.0
---

<!-- Source: open-design/design-systems/discord/DESIGN.md | License: Apache-2.0 | Imported: 2026-05-14 -->
