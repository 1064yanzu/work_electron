...
summary: "Figma's interface is the design tool that designed itself — a masterclass in typographic sophistication where a custom variable font (figmaS"
source: open-design
license: Apache-2.0
---

<!-- Source: open-design/design-systems/figma/DESIGN.md | License: Apache-2.0 | Imported: 2026-05-14 -->
