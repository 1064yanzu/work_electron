...
swatches: ["#EFE7D2", "#ECE4CF", "#DDD2B6", "#F7F1DE", "#15140F"]
summary: "A small, high-craft studio's annual report rendered as a webpage. The"
source: open-design
license: Apache-2.0
---

<!-- Source: open-design/design-systems/atelier-zero/DESIGN.md | License: Apache-2.0 | Imported: 2026-05-14 -->
# Atelier Zero
