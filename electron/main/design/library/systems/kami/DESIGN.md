...
swatches: ["#F5F4ED", "#1B365D", "#FFFFFF", "#E4ECF5", "#2D5A8A"]
summary: "kami compresses into one sentence: warm parchment canvas, ink-blue accent, serif carries hierarchy, no cool grays, no hard shadows. It is no"
source: open-design
license: Apache-2.0
---

<!-- Source: open-design/design-systems/kami/DESIGN.md | License: Apache-2.0 | Imported: 2026-05-14 -->
