...
type AgentCheckpointDeleteOutput = IPCSchema["agent_checkpoint_delete"]["output"];
type AgentCheckpointCleanupInput = IPCSchema["agent_checkpoint_cleanup"]["input"];
type AgentCheckpointCleanupOutput = IPCSchema["agent_checkpoint_cleanup"]["output"];
